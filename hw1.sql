...
CREATE TABLE `movie` (
  ...
  `movie_info` varchar(500) DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'newname','female',26),(2,'Lisi','female',24),(3,'Wangwu','male',25),(4,'Zhaoliu','male',26),(5,'Sunqi','female',27);
...
-- Dump completed on 2022-11-05  4:08:58
